...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    Product getProduct(int id) {
        ...
        Cursor cursor = db.query(TABLE_PRODUCT, new String[]{KEY_ID, KEY_NAME, KEY_DESCRIPTION, KEY_DESCRIPTION, KEY_REGULAR_PRICE, KEY_SALE_PRICE, KEY_IMAGE, KEY_COLORS, KEY_STORES}, KEY_ID + "=?", new String[]{String.valueOf(id)}, null, null, null, null);
        if (cursor != null) cursor.moveToFirst();

        return new Product(cursor.getString(1), cursor.getString(2), Double.parseDouble(cursor.getString(3)), Double.parseDouble(cursor.getString(4)), cursor.getString(5), convertStringToArray(cursor.getString(6)), stringToMap(cursor.getString(7)));
